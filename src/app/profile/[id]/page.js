    ...
    <div className="max-w-6xl mx-auto p-6">
      <div className="bg-white rounded-3xl shadow-xl border border-gray-200 p-8">
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div>
            <img
              src={profile.image_url || "https://via.placeholder.com/500"}
          ...
          <div>
            ...
            {isLoggedIn ? (
              <>
                ...
                <div className="mt-8 flex flex-wrap gap-3">
                  ...
                  <Link
                    ...
                    className="w-14 h-14 rounded-xl border shadow flex items-center justify-center hover:bg-blue-50 text-3xl"
                  >
                    💬
                  </Link>
                  ...
                  <Link
                    href="/dashboard/premium"
                    className="w-14 h-14 rounded-xl border shadow flex items-center justify-center hover:bg-green-50 text-3xl"
                  >
                    📞
                  </Link>
              ...
              <div className="mt-8 bg-pink-50 border border-pink-200 rounded-2xl p-5">
                <p className="mb-4">
                  Login to view full profile details and contact information.
                </p>
